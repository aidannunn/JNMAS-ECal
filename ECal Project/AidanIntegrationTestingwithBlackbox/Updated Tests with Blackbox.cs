...
namespace IntegrationTestingExpressionTreeBlackbox
{
    ...
    [TestFixture]
    public class Tests_Blackbox_Subtraction_with_division_with_parenthesis_right_side : Setup_and_Teardown
    {
        List<string> str;
        OperatorNode node1;
        OperatorNode node2;
        ...
        public void NewSetup()
        {
            ...
            str = new List<string> { "8", "2", "/", "3", "-"};

            //manually build the tree that is created by BuildTree() since the stubbed method won't create the tree, it only returns the root
            node1 = factory.CreateOperatorNode('-');
            node2 = factory.CreateOperatorNode('/');
            node3 = new ConstantNode(8);
            node4 = new ConstantNode(2);
            node5 = new ConstantNode(3);
            node1.Left = node2;
            node1.Right = node5;
            node2.Right = node4;
            node2.Left = node3;
    ...
    [TestFixture]
    public class Tests_Blackbox_Subtraction_with_division_with_parenthesis_left_side : Setup_and_Teardown
    {
        List<string> str;
        OperatorNode node1;
        OperatorNode node2;
        ...
        public void NewSetup()
        {
            ...
            str = new List<string> { "3", "6", "3", "/", "-" };

            //manually build the tree that is created by BuildTree() since the stubbed method won't create the tree, it only returns the root
            node1 = factory.CreateOperatorNode('-');
            node2 = factory.CreateOperatorNode('/');
            node3 = new ConstantNode(6);
            node4 = new ConstantNode(3);
            node5 = new ConstantNode(3);
            node1.Left = node5;
            node1.Right = node2;
            node2.Right = node4;
