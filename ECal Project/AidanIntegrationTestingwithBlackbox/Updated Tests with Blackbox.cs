...
namespace IntegrationTestingExpressionTreeBlackbox
{
    ...
    //  - Division ->                                                                                   6/3 = 2
    //  - Power ->                                                                                      3^2 = 9
    //  - Addition or subtraction next to multiplication or division with parenthesis right side ->     4/2 + 2 = 4
    //  - Addition or subtraction next to multiplication or division with parenthesis left side ->      2+4 / 2 = 4
    //  - Addition or subtraction next to multiplication or division without parenthesis right side -> (8/2) - 3 = 1
    //  - Addition or subtraction next to multiplication or division without parenthesis left side ->   3-(6/3) = 1
